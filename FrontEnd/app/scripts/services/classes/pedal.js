    ...
    .service('Pedal', ['Filter', function (Filter) {
        ...
        class Pedal {
            ...
            objectConstructor(pedalJSON, webaudio) {
                ...
                // Reinstantiating input and output
                ...
                // We re-populate the filters array
                var l = pedalJSON._filters.length;
                for (var i = 0; i < l; i++) {
                    // default filter
                    var filter = new Filter(pedalJSON._filters[i]._type, webaudio);

                    //Object constructor
                    // TODO : dans ce import, on recupere pas les params
                    filter.objectContructor(pedalJSON._filters[i], webaudio);
                ...
                // And finally, we add the easy stuff
